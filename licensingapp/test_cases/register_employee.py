...
class RegisterEmployeeTests(APITestCase):
    ...
    def test_success(self):
        print("register_employee test_success Test successful employee registration by admin")
        ...
        self.assertEqual(Employee.objects.filter(company=self.admin_company).count(), 2)

    def test_duplicate_username(self):
        print("register_employee test_duplicate_username Test employee registration with duplicate username")
    ...
    def test_no_capacity(self):
        print("register_employee test_no_capacity Test employee registration when no license capacity is available")
    ...
    def test_invalid_data(self):
        print("register_employee test_invalid_data Test employee registration with invalid data")
        payload = self.valid_payload.copy()
    ...
    def test_unauthenticated(self):
        print("register_employee test_unauthenticated Test employee registration without authentication")
        self.client.credentials()
        response = self.client.post(self.url, self.valid_payload, format='json')
        self.assertEqual(response.status_code, status.HTTP_401_UNAUTHORIZED)

    def test_not_admin(self):
        print("register_employee test_not_admin Test employee registration by a non-admin user")
    ...
    def test_admin_employee_not_found(self):
        print("register_employee test_admin_employee_not_found Test employee registration when admin employee is not found for the user")
